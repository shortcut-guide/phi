// /frontend/src/components/auth/paypal/PaypalLoginButton.tsx
"use client";
...
export default function PaypalLoginButton(props: Props) {
  ...
  return (
    ...
    >
      <svg aria-hidden="true" viewBox="0 0 24 24" width="18" height="18" className={disabled ? "animate-spin mr-2" : "mr-2"}>
